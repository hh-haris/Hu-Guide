        ...
        <div className="mobile-container pt-8">
          ...
          >
            <h1 className="font-secondary text-4xl font-bold text-brand-orange tracking-tight">
              USAT General Science
            </h1>
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">
              Comprehensive guide for USAT General Science stream preparation and requirements.
            </p>
            <div className="bg-brand-light-green dark:bg-gray-800 rounded-lg p-6 max-w-2xl mx-auto">
              <p className="text-muted-foreground text-sm">
                USAT General Science content coming soon. This page will contain detailed information about the General Science stream in USAT.
              </p>
            </div>
          </motion.div>
        </div>
