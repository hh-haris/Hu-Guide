        ...
        <div className="mobile-container pt-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">
              Comprehensive guide for USAT Medical stream preparation and requirements.
            </p>
            <div className="bg-brand-light-green dark:bg-gray-800 rounded-lg p-6 max-w-2xl mx-auto">
              <p className="text-muted-foreground text-sm">
                USAT Medical content coming soon. This page will contain detailed information about the Medical stream in USAT.
              </p>
            </div>
          </motion.div>
        </div>
