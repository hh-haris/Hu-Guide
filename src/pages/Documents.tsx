        ...
        <div className="mobile-container pt-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">
              Essential documents and requirements for your SHS application.
            </p>
            <div className="bg-brand-light-green dark:bg-gray-800 rounded-lg p-6 max-w-2xl mx-auto">
              <p className="text-muted-foreground text-sm">
                Documents content coming soon. This page will contain detailed information about required documents for SHS applications.
              </p>
            </div>
          </motion.div>
        </div>
