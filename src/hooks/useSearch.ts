...
const searchableData: SearchableContent[] = [
  ...
  // Registration and Application Process
  {
    ...
    content: "Step-by-step registration process for USAT",
    url: "/usat/registration-guide",
    type: "heading",
    keywords: ["registration", "guide", "signup", "apply", "process", "steps"],
    category: "Application"
  },
  {
    title: "Application Process",
    content: "Complete application submission process",
    url: "/timeline",
    type: "heading",
    keywords: ["application", "process", "submit", "apply", "procedure"],
    category: "Application"
  },
  ...
  // City-specific content
  {
    ...
    content: "Calculate living expenses in Hungarian cities",
    url: "/cities",
    type: "subheading",
    keywords: ["calculator", "cost", "living", "expenses", "budget", "estimate"],
    category: "Cities"
  },
  {
    title: "Job Situation",
    content: "Employment opportunities for students in different cities",
    url: "/cities",
    type: "subheading",
    keywords: ["job", "situation", "employment", "work", "opportunities", "student"],
    category: "Cities"
  },
  ...
  // Seniors and Community
  {
    ...
    content: "Connect with senior students already in Hungary",
    url: "/seniors",
    type: "heading",
    keywords: ["seniors", "students", "alumni", "experienced", "guidance", "mentors"],
    category: "Community"
  },
  {
    title: "Student Community",
    content: "Pakistani student community in Hungary",
    url: "/seniors",
    type: "heading",
    keywords: ["community", "pakistani", "students", "network", "support"],
    category: "Community"
  }
];
...
export function useSearch() {
  ...
  const searchResults = useMemo(() => {
    ...
    return sortedResults.slice(0, 8); // Limit to top 8 results
  }, [searchTerm]);
