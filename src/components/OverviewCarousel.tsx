        ...
        {showDetails && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-background rounded-2xl w-full max-w-sm max-h-[80vh] overflow-hidden border border-brand-gray dark:border-border"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="p-4 border-b border-brand-gray dark:border-border flex justify-between items-center">
                <h3 className="font-secondary font-bold text-lg text-brand-blue">Details</h3>
                <button
                  onClick={() => setShowDetails(false)}
                  className="p-1 hover:bg-brand-light-gray dark:hover:bg-gray-800 rounded-full smooth-transition"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
                ...
                <div className="space-y-4">
                  <ul className="space-y-1.5">
                    {[
                      ...
                      <li
                        key={idx}
                        className="flex items-start space-x-2 p-1 rounded-md hover:bg-brand-light-gray dark:hover:bg-gray-800 transition-colors duration-200"
                      >
